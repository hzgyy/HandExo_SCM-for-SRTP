...
//lwip default ip configuration
//lwipx:lwip control struct pointer
//---------------------------------
//Modified by YuanSu(yuan_sue@yeah.net) on 2023-04-28
//---------------------------------
void lwip_comm_default_ip_set(__lwip_dev *lwipx)
{
	...
	//due to the UnitreeZ1 device, set default remote ip 192.168.123.100
	lwipx->remoteip[0]=192;	
	lwipx->remoteip[1]=168;
	lwipx->remoteip[2]=123;
	...
	//default local ip 192.168.123.30
	lwipx->ip[0]=192;	
	lwipx->ip[1]=168;
	lwipx->ip[2]=123;
	lwipx->ip[3]=30;
...
void lwip_dhcp_task(void *pdata)
{
	...
	//这里如果我不使用DHCP
	//dhcp_start(&lwip_netif);		//开启DHCP //这里不使用动态获取IP的DHCP方法 2023-04-28
